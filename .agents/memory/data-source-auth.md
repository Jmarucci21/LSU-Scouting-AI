...
- **TruMedia data goes back to 2016** (per user, 2026-06-28) — deeper history than Telemetry/StatsBomb. When TruMedia raw-stats ingest is wired up, support seasons 2016+ (loop `seasonYear` back to 2016), not just the 2019-2025 range currently loaded.
