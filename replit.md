...
- Stats Explorer page (`/stats`): raw per-source stat lines across all of CFB, filter by source/stat-key/team/search, paginated. Current ingested sources: Hudl StatsBomb (tracking/speeds) + CFBD (PPA + season box stats).
